...
Set a config parameter called `defaultPackages`, a list of packages loaded by R at startup. It initally contains a system-deflined list. If I append package names to the list then R will load them, saving me from having to call `library` each time.
